...
- When a selected game is marked as played, it is locked for the current period.
- Recording play awards points.
- Playtime can be entered in 15-minute blocks when a game is recorded as played.
- Once a game has been played for the period, it should not be treated as available for another play entry in that same window.
...
- +10 points per 30 minutes played, using the entered 15-minute playtime blocks
